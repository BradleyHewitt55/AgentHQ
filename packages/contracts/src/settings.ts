...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Auto-open the plan sidebar when a new thread starts, keeping the
  // proposed plan visible without an extra click.
...
export const PiSettings = makeProviderSettingsSchema(
  {
    ...
    agentDir: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Custom Pi credentials, models, extensions, skills, and sessions directory.",
