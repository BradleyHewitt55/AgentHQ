...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverSubscribeUsageLimits]: AuthOrchestrationReadScope,
  [WS_METHODS.serverRefreshUsageLimits]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.projectsPaste]: AuthOrchestrationOperateScope,
