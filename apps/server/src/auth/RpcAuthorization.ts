...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.projectsMkdir]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectsMove]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectsDelete]: AuthOrchestrationOperateScope,
